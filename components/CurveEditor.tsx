    ...
    return (
        <div className="flex flex-col h-full">
            <div className={`flex items-center justify-between ${THEME.panel.header.padding}`}>
                <h2 className={`${THEME.panel.header.title} ${THEME.typography.color.label}`}>Mix curve</h2>
                <span className={`${THEME.typography.size.xs} ${THEME.typography.color.label} font-mono hidden sm:inline-block`}>
